<template>
    <div class="main">
        <button 
        class="coba"
        @click="toggleModal">Create Opportunity</button>
...
export default{
    ...
    methods:{
        async ambilData(){
            ...
            console.log(this.currentChat.meta)
            console.log(this.currentChat.meta.sender.name)
            console.log(this.currentChat.meta.sender.email)
            console.log(this.currentChat.meta.sender.phone_number)
            console.log(this.currentChat.meta.assignee.name)

            console.log(this.$refs.opp_name.value)
            console.log(this.$refs.expected_rev.value)
            ...
            const response2 = await fetch(`${url}/smsp_cw_opportunity`,{
                method: 'POST',
                headers: {
                    "content-type": "application/json"
                },
            ...
            // const response = await fetch(`${url}/smsp_cw_opportunity`)
